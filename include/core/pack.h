...
static const int OPK_M_BLK = VLEN / sizeof(f64);     // must be a multiple of VLEN / sizeof(f64)
static const int OPK_N_BLK = 2 * VLEN / sizeof(f64); // must be a multiple of VLEN / sizeof(f64)
